		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Xlsx Fact Telcel",
									"targetURL": "#capeetelcelxlsxfactview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capeetelcelxlsxfactview-display": {
								"semanticObject": "capeetelcelxlsxfactview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cap.ee.telcel.xlsxfactview",
									"url": sap.ui.require.toUrl("cap/ee/telcel/xlsxfactview")
								}
							}
						}
					}
