		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "XLSX-Fact-View-Plain",
									"targetURL": "#xlsxfactviewplain-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"xlsxfactviewplain-display": {
								"semanticObject": "xlsxfactviewplain",
								"action": "display",
								"description": "An HTML XLSX application.",
								"title": "XLSX-Fact-View-Plain",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=xlsxfactviewplain",
									"url": sap.ui.require.toUrl("xlsxfactviewplain")
								}
							}
						}
					}
