		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Huawei Counters View",
									"targetURL": "#uploadhuaweicountersview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uploadhuaweicountersview-display": {
								"semanticObject": "uploadhuaweicountersview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uploadhuaweicountersview",
									"url": sap.ui.require.toUrl("uploadhuaweicountersview")
								}
							}
						}
					}
