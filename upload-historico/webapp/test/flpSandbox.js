		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Carga Historico",
									"targetURL": "#uploadhistorico-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uploadhistorico-display": {
								"semanticObject": "uploadhistorico",
								"action": "display",
								"description": "A HTML application.",
								"title": "Carga Historico",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uploadhistorico",
									"url": sap.ui.require.toUrl("uploadhistorico")
								}
							}
						}
					}
